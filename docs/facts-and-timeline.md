...
| Tag no longer honored                                                                                                                                                      | **After May 31, 2027**    | Per Microsoft, the tag _"will no longer be honored, and all MANA-eligible VM series may be placed on MANA-capable hardware"_; have NVAs on a MANA-compatible config before this date, and Microsoft recommends removing the policy assignment afterward |
